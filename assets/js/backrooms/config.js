export const config = {
  ...
  INTRO_GIF: "/assets/nether-portal-animation.gif", // tiled background during the intro
  INTRO_SOUND: "/assets/nether-portal-sound.m4a", // intro advances when this sound ends
  INTRO_SKIPPABLE: true,
  INTRO_FALLBACK_MS: 4000,
  WIN_URL: "/",
  LOSE_URL: "https://www.gov.br/pt-br",
