function piada() {
  const piadas = [
    ...
    "Num concurso de morcegos, estavam fazendo uma disputa para ver quem era o melhor chupador de sangue. Chega o primeiro com a boca cheia de sangue e diz: </br>- Tá vendo aquela galinha morta ali? Fui eu. </br>Chega o segundo com a barriga tão cheia, mas tão cheia de sangue, que quase não conseguia voar. Ele diz: </br>- Tá vendo aquela vaca morta ali? Fui eu. </br>Chega o terceiro com sangue da cabeça aos pés, totalmente ensanguentado. O pessoal olha pra ele e fala: “Já ganhou, já ganhou”. Então ele diz: </br>- Tá vendo aquele muro ali? Eu não vi...",
  ];
